...
public class Bid {
    ...
    public Bid(double vat, double serviceCarage, double sipmentCharge, int bidId, int quantity, double price) {
        this.vat=vat;
        this.serviceCharge=serviceCarage;
        this.shippingCharge=sipmentCharge;
        this.id=bidId;
    ...
    public Bid(int bidId, int quantity, double price, double vat, double serviceCarage, double sipmentCharge, Address deliveryLocation) {
        this.vat=vat;
        this.serviceCharge=serviceCarage;
        this.shippingCharge=sipmentCharge;
        this.id=bidId;
    ...
    public Bid(int quantity, double price, double vat, double serviceCarage, double sipmentCharge, int commodityPostId, int buyerId,Address deliveryLocation) {
        this.vat=vat;
        this.serviceCharge=serviceCarage;
        this.shippingCharge=sipmentCharge;
        this.quantity=quantity;
    ...
    public Bid(int quantity, double price, double vat, double serviceCarage, int preOrderId, int sellerId, double sipmentCharge) {
        this.vat=vat;
        this.serviceCharge=serviceCarage;
        this.shippingCharge=sipmentCharge;
        this.quantity=quantity;
    ...
    public PreorderList getPreOrder() {
        return preOrder;
    }

    public void setPreOrder(PreorderList preOrder) {
